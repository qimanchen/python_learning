...
class OFPActionOutput(OFPAction):
    ...
    def __init__(self, port, max_len=ofproto.OFPCML_MAX,
        ...
        '''
        # the next three argument is add by man in 20180705
        self.central_frequency = 0
        self.slot_width = 0
        self.modulation_format = 0
        '''
    @classmethod
    def parser(cls, buf, offset): # cf sw mf is added in 20180705
    ...
    def serialize(self, buf, offset):
        msg_pack_into(ofproto.OFP_ACTION_OUTPUT_PACK_STR, buf,
                      offset, self.type, self.len, self.port, self.max_len)
                        # the last three arguments is added by man in 20180705
    '''
    # add_cf_sw_mf is added to this class in 20180705
    def add_cf_sw_mf(self,cf,sw,mf):
        self.central_frequency = cf
        self.slot_width = sw
        self.modulation_format = mf
    '''
