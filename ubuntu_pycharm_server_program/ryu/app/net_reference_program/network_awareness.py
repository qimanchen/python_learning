...
class NetworkAwareness(app_manager.RyuApp):
    """
    NetworkResourceAwareness is a Ryu app for discover topology information.
    ...
    def switch_features_handler(self, ev):
        """
        Initial operation, send miss-talbe flow entry to datapaths.
        :param ev:
        :return:
        """
        ...
        # print switch link with controller info
    ...
    def k_shortest_paths(self, graph, src, dst, weight='weight', k=1):
        """
        Creat K shortest paths of src to dst.
        :param graph:
        :param src:
        :param dst:
        :param weight:
    ...
    def get_topology(self, ev):
        ...
        self.shortest_paths = self.all_k_shortest_paths(self.graph,
                                                        weight='weight',
                                                        k=CONF.k_paths)

    # deal the packet in event
    ...
    def packet_in_handler(self, ev):
        ...
        # parser different protocol info
