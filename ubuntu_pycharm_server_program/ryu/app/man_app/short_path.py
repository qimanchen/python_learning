...
class ShortPath(app_manager.RyuApp):
    ...
    def packet_in_handler(self,ev):
        ...
        #     switch_list = get_switch(self.topology_api_app, None)
        #     switches = [switch.dp.id for switch in switch_list]
        #     print "man-test", switches
        #     print "\n\n"
        #     # get links
        #     links_list = get_link(self.topology_api_app, None)
        #     links = [(link.src.dpid, link.dst.dpid, {'port': link.src.port_no}) for link in links_list]
        #     print "man-test", links
        #     print "\n\n"
        #     links = [(link.dst.dpid, link.src.dpid, {'port': link.dst.port_no}) for link in links_list]
        #     print "man-test", links
        #     print "\n\n"
...
# bridge = self.stp.bridge_list[1]
        # print("\n\n")
        # print("man-> test", bridge.ports_state)
        # print("\n\n")
        # test = bridge.ports[1]
        # print("man-> test", test.dpid_str, "--", test.state, test.role, test.ofport)
        # print("\n\n")
        # time.sleep(60)
