...
class Mininet( object ):
    ...
    # add for iperf_multi in 20180721
    def iperf_single(self,hosts=None,udpBw='10M',period=5,port=5001):
        ...
        bwArgs = '-b' + udpBw+ ' '
        print "***start server***"
        server.cmd(iperfArgs + '-s' + ' > /home/odl/log/' + filename + '&')
        print "***start client***"
        client.cmd(
            iperfArgs + '-t ' + str(period) + ' -c ' + server.IP() + ' ' +bwArgs
            + ' > /home/odl/log/' + 'client' + filename +'&')
    ...
    def iperfMulti(self,bw,period=5):
        ...
        for i in xrange(0,_len):
            ...
            sleep(.05)
            base_port += 1
        self.hosts[0].cmd('ping -c10'+self.hosts[-1].IP() + ' > /home/odl/log/delay.out')
        sleep(period)
